...
(function dartProgram() {
  ...
  P = {
    ...
    String_String$fromCharCodes: function(charCodes) {
      ...
      t1 = H.Primitives_stringFromNativeUint8List(charCodes, 0, P.RangeError_checkValidRange(0, null, charCodes.length));
      return t1;
    },
  ...
  M = {
    SseClient$: function(serverUrl) {
      ...
      t3 = F.Logger_Logger("SseClient");
      t4 = new P.ListQueue(type$.ListQueue_dynamic);
      t5 = new Array(8);
      t5.fixed$length = Array;
      t4.set$_table(H.setRuntimeTypeInfo(t5, type$.JSArray_dynamic));
      t4 = new M.SseClient(t2, t1, t3, t4, P.StreamController_StreamController(type$.Null));
      t4.SseClient$1(serverUrl);
      return t4;
    },
  ...
  P._StreamIterator.prototype = {
    ...
    _initializeOrDone$0: function() {
      ...
      if (stateData != null) {
        _this._subscription = _this.$ti._eval$1("Stream<1>")._as(stateData).listen$4$cancelOnError$onDone$onError(_this.get$_onData(), true, _this.get$_onDone(), _this.get$_onError());
  ...
  W._EventStreamSubscription.prototype = {
    ...
    set$_html$_onData: function(_onData) {
      this._html$_onData = type$.dynamic_Function_Event._as(_onData);
    }
  };
  ...
  M.SseClient.prototype = {
    ...
    _onOutgoingMessage$1: function(message) {
      var $async$goto = 0,
        ...
        $async$self = this, t3, t4, newTable, split, t1, t2;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              C.JSArray_methods.$indexSet(t1._table, t1._tail, message);
              t3 = t1._tail;
              t4 = t1._table.length;
              t3 = (t3 + 1 & t4 - 1) >>> 0;
              t1._tail = t3;
              if (t1._head === t3) {
                ...
                newTable = H.setRuntimeTypeInfo(t3, t2._eval$1("JSArray<1>"));
                t2 = t1._table;
                t3 = t1._head;
                split = t2.length - t3;
              ...
              $async$self._messageEvents.add$1(0, null);
              // implicit return
    ...
    _startPostingMessages$0: function() {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.dynamic),
        $async$handler = 1, $async$currentError, $async$next = [], $async$self = this, batch, e, e0, t2, t3, list, exception, t4, t1, $async$exception, $async$temp1;
      var $async$_startPostingMessages$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self._messageEvents;
              t1 = new P._StreamIterator(new P._ControllerStream(t1, H._instanceType(t1)._eval$1("_ControllerStream<1>")), type$._StreamIterator_Null);
              $async$handler = 2;
              t2 = $async$self._logger, t3 = $async$self._messages;
            case 5:
              // for condition
              $async$temp1 = H;
              $async$goto = 7;
            ...
            case 7:
              ...
              t1.get$current();
              list = H.setRuntimeTypeInfo([], t3.$ti._eval$1("JSArray<1>"));
              C.JSArray_methods.set$length(list, (t3._tail - t3._head & t3._table.length - 1) >>> 0);
              t3._writeToList$1(list);
              batch = list;
              if (J.get$length$asx(batch) === 0) {
                // goto for condition
                $async$goto = 5;
                break;
              }
              ...
              $async$handler = 9;
              $async$goto = 12;
              return P._asyncAwait(W.HttpRequest_request($async$self._serverUrl, "POST", C.C_JsonCodec.encode$2$toEncodable(batch, null), true), $async$_startPostingMessages$0);
            case 12:
              // returning from await.
              $async$handler = 2;
              // goto after finally
            ...
            case 9:
              ...
              if (t4 instanceof P.JsonUnsupportedObjectError) {
                e = t4;
                t2.log$4(C.Level_WARNING_900, "Unable to encode outgoing message: " + H.S(e), null, null);
              } else if (t4 instanceof P.ArgumentError) {
                e0 = t4;
  ...
  E.main_closure0.prototype = {
    call$1: function(s) {
      ...
      t1.add$1(0, H._instanceType(t1)._precomputed1._as(H._asStringNullable(s)));
    },
    $signature: 26
  };
  (function aliases() {
  ...
  var init = {
    ...
    metadata: [],
    types: ["~()", "Null()", "~(@)", "~(Object[StackTrace])", "@(@)", "Null(@,@)", "~(~())", "Null(@)", "Null(Symbol0,@)", "String(int)", "~(Event)", "Null(Event)", "Null(String,@)", "@(@,String)", "@(String)", "Null(~())", "Null(@,StackTrace)", "Null(int,@)", "Null(@[StackTrace])", "_Future<@>(@)", "~(Object)", "Null(ProgressEvent)", "@(Event)", "@(@,@)", "Logger()", "Null(MouseEvent)", "Null(String)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JavaScriptFunction":"JavaScriptObject","PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","_ResourceProgressEvent":"ProgressEvent","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","MessagePort":"EventTarget","HtmlDocument":"Node","Document":"Node","NativeFloat32List":"NativeTypedArrayOfDouble","JSBool":{"bool":[]},"JSNull":{"Null":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"int":[],"double":[],"num":[]},"JSDouble":{"double":[],"num":[]},"JSString":{"String":[],"Pattern":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"Symbol":{"Symbol0":[]},"ConstantMapView":{"UnmodifiableMapView":["1","2"],"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"JSInvocationMirror":{"Invocation":[]},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"LinkedHashMap":["1","2"],"MapMixin":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["@"]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"JavaScriptIndexingBehavior":["@"],"List":["double"],"FixedLengthListMixin":["double"],"Iterable":["double"],"ListMixin.E":"double"},"NativeTypedArrayOfInt":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"]},"NativeInt16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"List":["int"],"JavaScriptIndexingBehavior":["@"],"FixedLengthListMixin":["int"],"Iterable":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_TimerImpl":{"Timer":[]},"_AsyncCompleter":{"_Completer":["1"]},"_Future":{"Future":["1"]},"_StreamController":{"StreamController":["1"],"_EventDispatch":["1"],"_StreamControllerLifecycle":["1"]},"_AsyncStreamController":{"_AsyncStreamControllerDispatch":["1"],"_StreamController":["1"],"StreamController":["1"],"_EventDispatch":["1"],"_StreamControllerLifecycle":["1"]},"_ControllerStream":{"_StreamImpl":["1"],"Stream":["1"]},"_ControllerSubscription":{"_BufferingStreamSubscription":["1"],"_EventDispatch":["1"],"StreamSubscription":["1"]},"_BufferingStreamSubscription":{"_EventDispatch":["1"],"StreamSubscription":["1"]},"_StreamImpl":{"Stream":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedError":{"_DelayedEvent":["@"]},"_DelayedDone":{"_DelayedEvent":["@"]},"_StreamImplEvents":{"_PendingEvents":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"Zone":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ListQueue":{"ListIterable":["1"],"Queue":["1"],"Iterable":["1"],"ListIterable.E":"1"},"_JsonMap":{"MapMixin":["String","@"],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonUnsupportedObjectError":{"Error":[]},"JsonCyclicError":{"Error":[]},"JsonCodec":{"Codec":["Object","String"],"Codec.S":"Object"},"JsonEncoder":{"Converter":["Object","String"]},"JsonDecoder":{"Converter":["String","Object"]},"double":{"num":[]},"AssertionError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"NoSuchMethodError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"int":{"num":[]},"List":{"Iterable":["1"]},"_StringStackTrace":{"StackTrace":[]},"String":{"Pattern":[]},"StringBuffer":{"StringSink":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"Element":{"EventTarget":[]},"EventSource":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"HttpRequest":{"EventTarget":[]},"HttpRequestEventTarget":{"EventTarget":[]},"MessageEvent":{"Event":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"ProgressEvent":{"Event":[]},"SelectElement":{"Element":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"_JSRandom":{"Random":[]},"SvgElement":{"Element":[],"EventTarget":[]},"HexCodec":{"Codec":["List<int>","String"],"Codec.S":"List<int>"},"HexEncoder":{"Converter":["List<int>","String"]}}'));
  H._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"StreamTransformerBase":2,"MapBase":2,"StreamChannelMixin":1}'));
  var type$ = (function rtii() {
    ...
    return {
      ...
      _StreamIterator_Null: findType("_StreamIterator<Null>"),
      bool: findType("bool"),
